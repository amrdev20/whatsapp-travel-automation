...
class SessionService {
   ...
   */
  updateContext(phone: string, newContext: Partial<FlightSearchContext>) {
   ...
   * Get session context
   */
  getContext(phone: string): FlightSearchContext {
   ...
   */
  getMessages(phone: string): Array<{ role: 'user' | 'assistant'; content: string }> {
