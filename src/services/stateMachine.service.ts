...
export enum ConversationState {
  ...
  SEARCHING_PACKAGES = 'SEARCHING_PACKAGES',
  PACKAGES_DISPLAYED = 'PACKAGES_DISPLAYED',
  PACKAGE_SELECTED = 'PACKAGE_SELECTED',

  // Passenger details states
  COLLECTING_PASSENGER_NAME = 'COLLECTING_PASSENGER_NAME',
  COLLECTING_EMAIL = 'COLLECTING_EMAIL',
  COLLECTING_PHONE = 'COLLECTING_PHONE',
  COLLECTING_DOB = 'COLLECTING_DOB',
  COLLECTING_PASSPORT = 'COLLECTING_PASSPORT',
  COLLECTING_PASSPORT_EXPIRY = 'COLLECTING_PASSPORT_EXPIRY',
...
class StateMachineService {
  private transitions: Map<ConversationState, StateTransition[]> = new Map();
   ...
   */
  getNextState(context: StateContext): ConversationState {
   ...
   */
  async transition(context: StateContext): Promise<StateContext> {
   ...
   */
  getStatePrompt(state: ConversationState, context: StateContext): string {
    const prompts: { [key in ConversationState]?: string } = {
   ...
   */
  shouldCallAPI(state: ConversationState): 'search' | 'book' | null {
   ...
   */
  isStateComplete(context: StateContext): boolean {
   ...
   */
  resetConversation(): StateContext {
    return {
   ...
   */
  getContextSummary(context: StateContext): string {
    const summary = {
