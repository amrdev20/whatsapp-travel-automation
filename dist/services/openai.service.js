...
class OpenAIService {
     ...
     */
    async extractFlightInfo(userMessage, currentContext = {}) {
        try {
...
Only include fields clearly mentioned. Return empty JSON {} if nothing found.`;
     ...
     */
    isReadyToSearch(context) {
        return !!(context.departureCode &&
            context.arrivalCode &&
     ...
     */
    async extractCountryCode(countryName) {
        try {
