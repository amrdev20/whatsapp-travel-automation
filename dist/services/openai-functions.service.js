...
const collectBookingDataFunction = {
    type: 'function',
    function: {
...
class OpenAIFunctionsService {
     ...
     */
    async processBookingData(messages) {
        try {
            const systemMessage = {
                role: 'system',
...
- Don't keep asking for confirmation - once user confirms, call the function!`
     ...
     */
    async generateFollowUpResponse(messages, functionResult) {
        try {
...
exports.default = new OpenAIFunctionsService();
